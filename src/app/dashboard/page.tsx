...
export default function DashboardPage() {
  ...
  // Recent combined transactions feed
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
          <div>
            <h3 className="text-sm font-semibold text-slate-800">Purchases vs Sales Trend</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {notifications.slice(0, 4).map(notif => (
              <div 
                ...
                className={`p-3 rounded-lg border flex items-start gap-3 transition ${
                  notif.type === 'danger' ? 'bg-red-50/50 border-red-100 text-red-700' :
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
          <div className="border-b border-slate-100 pb-3">
            ...
            <p className="text-[10px] text-slate-400 mt-0.5">Latest documents and ledger changes</p>
          </div>
              ...
              <div key={t.id} className="flex items-center justify-between text-xs">
                ...
                <div className="text-right">
                  <span className="font-bold text-slate-800 block">
                    {t.amount ? `₹${t.amount.toLocaleString()}` : 'Cleared'}
                  </span>
